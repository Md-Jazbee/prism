...
| [0003](./0003-mcp-transport-hand-rolled.md) | MCP transport stays hand-rolled stdio | Accepted | P8 (reaffirmed — see 0006) |
| [0005](./0005-otlp-exporter-deferred.md) | OTLP exporter deferred (env hook only) | Accepted | P7 |
| [0006](./0006-extension-binary-delivery.md) | Extension binary: PATH first, download fallback | Accepted | — |
